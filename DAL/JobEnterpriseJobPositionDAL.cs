    ...
    public partial class JobEnterpriseJobPositionDAL
    {
        ...
        public int Add(zlzw.Model.JobEnterpriseJobPositionModel model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@JobPositionName", SqlDbType.NVarChar,50),
            ...
            parameters[42].Value = model.PropertyNames;
            parameters[43].Value = model.PropertyValues;

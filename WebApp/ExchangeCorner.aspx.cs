...
namespace WebApp
{
    public partial class ExchangeCorner : System.Web.UI.Page
    {
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (lit == System.Web.UI.WebControls.ListItemType.Item || lit == System.Web.UI.WebControls.ListItemType.AlternatingItem)
            {
                ...
                {
                    labMenuItem.Text = "<td style='width:100%;'><a href='ExchangeCorner.aspx?id=" + drv["DisplayName"].ToString() + "' style='text-decoration:none;color:#fff;color:#093C7E;'>" + drv["SettingValue"].ToString() + "</a></td>";
                }

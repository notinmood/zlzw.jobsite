<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEnterpriseServiceType.aspx.cs" Inherits="WebApp.Manage.admin.AddEnterpriseServiceType" %>
        ...
        <Toolbars>
            <x:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <x:ToolbarText ID="ToolbarText2" Text="添加一个新的企业服务类型　" runat="server">
                    </x:ToolbarText>
                </Items>
            </x:Toolbar>
        </Toolbars>
            ...
            <x:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" Height="450px">
                <Items>
                    <x:SimpleForm ID="SimpleForm1" ShowBorder="true" ShowHeader="false" EnableLightBackgroundColor="true"
                        ...
                        <Items>
                            <x:TextBox ID="txbEnterpriseServiceTypeName" runat="server" Label="类型名称" EmptyText="企业服务类型" Required="true"
                                RequiredMessage="企业服务类型不能为空">
                            </x:TextBox>
                            <x:TextBox ID="txbOrderNumber" runat="server" Label="排序号" EmptyText="排序号" Required="true" RegexMessage="排序号不能为空"></x:TextBox>
                            <x:CheckBox ID="ckbIsHot" runat="server" Label="热门服务"></x:CheckBox>
                        </Items>
                    </x:SimpleForm>
                </Items>
            </x:Panel>

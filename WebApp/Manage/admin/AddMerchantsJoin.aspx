<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AddMerchantsJoin.aspx.cs" Inherits="WebApp.Manage.admin.AddMerchantsJoin" %>
            ...
            <x:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" Height="450px">
                <Items>
                    <x:SimpleForm ID="SimpleForm1" ShowBorder="true" ShowHeader="false" EnableLightBackgroundColor="true"
                        ...
                        <Items>
                            <x:Label ID="labPublishName" runat="server" Label="发布人"></x:Label>
                            <x:HtmlEditor ID="txbContent" runat="server" Label="加盟内容"></x:HtmlEditor>
                        </Items>
                    </x:SimpleForm>
                </Items>
            </x:Panel>

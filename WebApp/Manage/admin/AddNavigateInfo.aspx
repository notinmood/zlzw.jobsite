<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AddNavigateInfo.aspx.cs" Inherits="WebApp.Manage.admin.AddNavigateInfo" %>
        ...
        <Toolbars>
            <x:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <x:ToolbarText ID="ToolbarText2" Text="添加一个新的导航内容" runat="server">
                    </x:ToolbarText>
                </Items>
            </x:Toolbar>
        </Toolbars>
                ...
                <Items>
                    <x:SimpleForm ID="SimpleForm1" ShowBorder="true" ShowHeader="false" EnableLightBackgroundColor="true"
                        ...
                        <Items>
                            ...
                            <x:DropDownList ID="drpNavigateGUID" runat="server" Label="所属类型"></x:DropDownList>
                            <x:TextBox ID="txbNavigateInfoTitle" runat="server" Label="内容标题" EmptyText="内容标题" Required="true"
                                RequiredMessage="内容标题不能为空">
                            </x:TextBox>
                            <x:HtmlEditor ID="txbNavigateInfoContent" runat="server" Label="内容"></x:HtmlEditor>
                        </Items>
                    </x:SimpleForm>
                </Items>
            </x:Panel>

...
{
    public partial class EnterpriseServiceTypeList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                grid1.RecordCount = Get_EnterpriseServiceTypeListTotalCount();//获取总页数
                #region 管理员列表绑定

                EnterpriseServiceTypeList_BindGrid();

                #endregion
                Window1.Title = "添加企业服务类型";
                btnAdd.OnClientClick = Window1.GetShowReference("AddEnterpriseServiceType.aspx?Type=0", "添加企业服务类型") + "return false;";
                btnDel.OnClientClick = grid1.GetNoSelectionAlertReference("请选择要删除的企业服务类型!");
            }
        }
        ...
        {
            return "javascript:" + Window1.GetShowReference("AddEnterpriseServiceType.aspx?Type=1&value=" + value, "编辑企业服务类型");

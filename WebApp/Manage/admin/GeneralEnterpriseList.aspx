        ...
        <Items>
            <x:Grid ID="grid1" PageSize="10" ShowBorder="true" ShowHeader="false"
                ...
                <Columns>
                    ...
                    <x:CheckBoxField Width="50px" DataField="IsEnablePublishJob" HeaderText="职位发布" TextAlign="Center" />
                    <x:CheckBoxField Width="50px" DataField="IsEmergencyRecruitment" HeaderText="紧急发布" TextAlign="Center"/>
                    <x:BoundField Width="100px" DataField="DownloadResume" HeaderText="陌生简历下载次数" TextAlign="Center" />

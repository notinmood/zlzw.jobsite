...
namespace WebApp
{
    public partial class NaviagteInfo : System.Web.UI.Page
    {
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (lit == System.Web.UI.WebControls.ListItemType.Item || lit == System.Web.UI.WebControls.ListItemType.AlternatingItem)
            {
                ...
                {
                    labMenuItem.Text = "<td style='width:100%;'><a href='NaviagteInfo.aspx?id=" + drv["NavigateGUID"].ToString() + "' style='text-decoration:none;color:#fff;color:#093C7E;'>" + drv["NavigateName"].ToString() + "</a></td>";
                }

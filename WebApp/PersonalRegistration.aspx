<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="PersonalRegistration.aspx.cs" Inherits="WebApp.PersonalRegistration" %>
            ...
            <div id="wapper" class="top2right">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%; margin-left:200px;-margin-left:330px;text-align:left;">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width:410px;"> 
                                <asp:DropDownList ID="drpUserSex" Height="26" CssClass="easyui-combobox" Width="405" runat="server">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width:410px;"> 
                                <asp:DropDownList ID="drpUserEducationalBackground" Height="26" CssClass="easyui-combobox" Width="405" runat="server">
                                </asp:DropDownList>
                            </td>
                            <td align="left" style="color:#6e6e6e;font-size:14px;">
                                <span style="font-weight:bold; color:#f00;"></span>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobFeildKinds.aspx.cs" Inherits="WebApp.TemplatePage.JobFeildKinds" %>
                ...
                <td>
                    <table>
                        <thead>
                            <tr>
                                <td>
                                    <span style="color:#093C7E; font-size:14px; font-weight:bold;">&nbsp;&nbsp;制造行业</span>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <td valign="top">
                    <table>
                        <thead>
                            <tr>
                                <td>
                                   <span style="color:#093C7E; font-size:14px; font-weight:bold;">&nbsp;&nbsp;第三产业</span>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <asp:DataList ID="DataList2" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" OnItemDataBound="DataList2_ItemDataBound">
                                        <ItemTemplate>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="labTertiaryIndustry" runat="server"></asp:Label>
                                                    </td>
                                                    <td style="width:10px;">
                ...
                <td valign="top">
                    <table>
                        <thead>
                            <tr>
                                <td>
                                   <span style="color:#093C7E; font-size:14px; font-weight:bold;">&nbsp;&nbsp;第一产业</span>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>
                                    <asp:DataList ID="DataList3" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" OnItemDataBound="DataList3_ItemDataBound">
                                        <ItemTemplate>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="labPrimaryIndustry" runat="server"></asp:Label>
                                                    </td>
                                                    <td style="width:10px;">
    ...
    <script type="text/javascript">
        ...
        $().ready(function () {
            $("input[type*='checkbox']").bind('change', function () {
                ...
                var input = origin.document.getElementById('txbJobFeildKinds');
                input.value = aValue;
                input.select();
                art.dialog.close();

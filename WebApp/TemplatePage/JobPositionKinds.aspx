<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobPositionKinds.aspx.cs" Inherits="WebApp.TemplatePage.JobPositionKinds" %>
                ...
                <td>
                    <table>
                        <thead>
                            <tr>
                                <td>
                                    <span style="color:#093C7E; font-size:14px; font-weight:bold;">&nbsp;&nbsp;非管理类</span>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <td valign="top">
                    <table>
                        <thead>
                            <tr>
                                <td>
                                   <span style="color:#093C7E; font-size:14px; font-weight:bold;">&nbsp;&nbsp;管理类</span>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <asp:DataList ID="DataList2" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" OnItemDataBound="DataList2_ItemDataBound">
                                        <ItemTemplate>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="labJobPositionKinds01" runat="server"></asp:Label>
                                                    </td>
                                                    <td style="width:10px;">
    ...
    <script type="text/javascript">
        ...
        $().ready(function () {
            $("input[type*='checkbox']").bind('change', function () {
                ...
                var input = origin.document.getElementById('txbJobPositionKinds');
                input.value = aValue;
                input.select();
                art.dialog.close();
